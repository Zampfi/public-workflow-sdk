...
from sample.params import YourParams, HumanApprovalActivityInput, HumanApprovalActivityOutput, FinalActivityInput, FinalActivityOutput, JokeActivityInput, JokeActivityOutput
...
# human in the loop
@activity.defn
async def human_approval(params: HumanApprovalActivityInput) -> HumanApprovalActivityOutput:
