...
async def return_mocked_result(node_id: str, label: str, output: Any) -> Any:
    """
    ...
    Args:
        ...
        label: Label describing what was mocked (e.g., "response mocked {node_id}")
    ...
    logger.info("Returning mocked result", label=label, node_id=node_id)
    return output
