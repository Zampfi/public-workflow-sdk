...
from constants.workflow_history import (
    EventType,
    PayloadField,
...
from models.node_payload_data import (
    NodePayloadData,
)
...
def extract_node_payloads(
    ...
    for event_index, event in enumerate(events):
        ...
        # Skip if node_id is not defined or not in target list
        if node_id is None or not _should_include_node_id(node_id, node_ids):
            continue
